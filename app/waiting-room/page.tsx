...
// Placeholder page for the waiting room feature.
// In future iterations this could show pending guests, queue status, and simple check-in actions.
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-screen-2xl px-6 py-6 gap-6 text-[#022c22]">
        <aside className="hidden w-56 flex-shrink-0 flex-col rounded-2xl border border-emerald-500/30 bg-white p-4 shadow-[0_0_30px_rgba(16,185,129,0.15)] md:flex">
          ...
          <nav className="mt-4 space-y-1 text-sm">
            ...
            <Link
              href="/waiting-room"
              className="mt-2 flex w-full items-center justify-between rounded-xl px-3 py-2 text-left text-sm bg-emerald-50 text-[#022c22]"
            >
        ...
        <main className="flex-1">
          ...
          <p className="mt-1 text-sm text-zinc-600">
            This is a placeholder Waiting Room page. Navigation is wired; we
